...
### PreToolUse Safety Guard Templates

All guard templates below use Unix (macOS/Linux) syntax. This is the default for all platforms except Windows. For Windows (PowerShell) equivalents, see the **Windows Platform Overrides** section below.
...
Use these PowerShell equivalents **only** when the platform is confirmed as Windows. Do not use these on macOS or Linux.
